...
export const Ln =()=> {
    return (
        ...
        <a href="http://www.linkedin.com/in/pedro-martínez" target ="_blank" class="z-5 text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
