...
export const Github =() => {
    return (
        <a href="https://github.com/pmartinez19/hello_pages" target ="_blank" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
